...
const APP_ROUTES: Routes = [
  ...
  {
    path: "lote/:id/registros-plagas",
    component: RegistroPlagasComponent,
    canActivate: [AuthGuard],
  },
  {
  ...
  {
    path: "listado-plagas",
    component: ListadoPlagasComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "nueva-plaga",
    component: NuevaPlagaComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "nueva-plaga/:nombre_comun_plaga",
    component: NuevaPlagaComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "listado-agroquimicos",
    component: ListadoAgroquimicosComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "nuevo-agroquimico",
    component: NuevoAgroquimicosComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "nuevo-agroquimico/:id_producto_agroquimico",
    component: NuevoAgroquimicosComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "listado-enfermedad",
    component: ListadoEnfermedadesComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "editar-enfermedad/:nombre_enfermedad",
    component: EditarEnfermedadComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "editar-etapa-enfermedad/:nombre_enfermedad",
    component: EditarEtapaEnfermedadComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "nueva-enfermedad",
    component: NuevaEnfermedadComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "rendimiento-productivo",
    component: RendimientoProductivoComponent,
    canActivate: [AuthGuard],
  },
  ...
  {
    path: "registro-tratamientos",
    component: AplicacionesComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "censo-productivo",
    component: CensoProductivoComponent,
    canActivate: [AuthGuard],
  },
